...
function Button({ value }) {
	return (
		<button
			...
			className="mt-6 transition-all block py-3 px-4 w-full text-white font-bold rounded cursor-pointer bg-[#ff6666] hover:bg-[#66ffff] transform hover:-translate-y-1 hover:shadow-lg"
		>
			{value}
		</button>
	);
